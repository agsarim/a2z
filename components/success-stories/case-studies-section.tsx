...
const caseStudies = [
  {
    ...
    genre: "Business Leadership",
        image: "/images/clients/brenda-bence.png",
  ...
  },
  {
    ...
    image:  "/images/clients/gavin-coyle.webp",
  ...
  },
  {
    ...
    image:  "/images/clients/albert-griesmayr.jpg",
  ...
  },
  {
    ...
    image: "/images/clients/uma-vanka.jpg",
              ...
              <AccordionItem value={study.id} className="mb-4 border-b-0">
                <AccordionTrigger className="flex items-center gap-4 p-6 bg-slate-100 rounded-xl shadow-sm hover:bg-slate-200 transition-all duration-300 text-left">
                  <Image
                    ...
                    width={60}
                    height={60}
                    className="h-[60px] w-[60px] rounded-full object-cover object-top flex-shrink-0 bg-white"
                    unoptimized
                  />
